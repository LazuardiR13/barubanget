      ...
      <div className="w-full lg:w-6/12 px-4">
        <div className="rounded-t mb-0 px-6 py-6">
          ...
          <div className='mx-32 my-5 justify-center'>
            ...
            <input type="email" name='email' value={email} className='block w-96 h-7 rounded-sm border-b-2' placeholder='Contoh : portgasace@invest.com ' onChange={this.handleChange} />
